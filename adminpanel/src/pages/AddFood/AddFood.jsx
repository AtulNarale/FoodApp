      ...
      <div className="card-body">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <div className="mb-3">
            ...
            <input type="text"  placeholder = 'Chiken Birynai' className="form-control" id="name" required name='name' 
            onChange={onChangeHandler} value={data.name}/>
          </div>
          
          <div className="mb-3">
            <label htmlFor="description" className="form-label">Description</label>
            <textarea className="form-control"placeholder='Write Content.....' id="message" rows="5" required name='description' 
          ...
          <div className="mb-3">
            ...
            <input type="number" placeholder="₹200" name='price' id='price' className='form-control' 
