...
const Cart = () => {
    ...
    const { foodList, quantities, incrementQuantity, decrementQuantity ,removeFromCart } = React.useContext(StoreContext);
                                    ...
                                    {cartItems.map((food) => (
                                        <div key={food.id} className="row cart-item mb-3">
                                            ...
                                            <div className="col-md-2 text-end">
                                                ...
                                                <button className="btn btn-sm btn-outline-danger" type="button" onClick={()=> 
